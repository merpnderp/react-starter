...
/***/ function(module, exports, __webpack_require__) {
	...
	var blur = __webpack_require__(161).blur;
	...
	img.onload = function () {
	    ...
	    */
	    ...
	    imageData = ctx.getImageData(0, 0, canvas.width, canvas.height);
	    data = imageData.data;
	    data = blur(data, imageData.width, imageData.height, 75);
	    for (var _i = 0; _i < data.length; _i += 4) {
	        var closest = Number.MAX_SAFE_INTEGER;
	        var closestIndex = 0;
	        for (var o = 0; o < km.centroids.length; o++) {
	            var dist = findDistance([data[_i], data[_i + 1], data[_i + 2]], [km.centroids[o][0], km.centroids[o][1], km.centroids[o][2]]);
...
/***/ function(module, exports) {
	...
	var horizontalConvolve = function horizontalConvolve(pixels, width, height, weightsVector, opaque) {
	...
	var verticalConvolve = function verticalConvolve(pixels, width, height, weightsVector, opaque) {
	    var side = weightsVector.length;
	    var halfSide = Math.floor(side / 2);
	    var output = new Float32Array(width * height * 4);
	    var alphaFac = opaque ? 1 : 0;
	...
	var separableConvolve = function separableConvolve(pixels, width, height, horizWeights, vertWeights, opaque) {
